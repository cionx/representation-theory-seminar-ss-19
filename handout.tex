...
It follows that for every (left)~{\representation{$\symm_n$}}~$E$ we get a~{\representation{$\GL(V)$}}
\[
  \Schur(E)
  \defined
...
%     \end{ytableau}
%   \]
%   It follows that~$f^\lambda = f_\mu = 1$ and therefore
%   \[
%     V \tensor V
%     =
%     V^{\tensor 2}
%     \cong
%     S^{\lambda}(V)^{\oplus f^\lambda}
%     \oplus
%     S^{\mu}(V)^{\oplus f_\mu}
%     \cong
...
%     \item
%       For every partition~$\lambda$ there exist unique natural numbers~$K_{\mu, \lambda}$ for~$\tilde{\mu} \strictlydominated \lambda$ such that one and thus all of the following conditions hold:
%       \begin{enumerate}
%         \item
%           $\widetilde{M}^{\tilde{\lambda}} \cong S^{\tilde{\lambda}} \oplus \bigoplus_{\tilde{\mu} \strictlydominated \lambda} (S^\mu)^{\oplus K_{\tilde{\mu}, \lambda}}$,
%         \item
%           $\widetilde{M}^{\tilde{\lambda}}(V) \cong S^{\tilde{\lambda}}(V) \oplus \bigoplus_{\tilde{\mu} \strictlydominated \lambda} S^\mu(V)^{\oplus K_{\tilde{\mu}, \lambda}}$,
%         \item
%           $e_{\tilde{\lambda}}(x_1, \dotsc, x_m) = s_{\tilde{\lambda}}(x_1, \dotsc, x_m) + \sum_{\tilde{\mu} \strictlydominated \lambda} K_{\tilde{\mu}, \lambda} s_\mu(x_1, \dotsc, x_m)$,
%         \item
%           $e_{\tilde{\lambda}} = s_{\tilde{\lambda}} + \sum_{\tilde{\mu} \strictlydominated \lambda} K_{\tilde{\mu}, \lambda} s_\mu$.
%       \end{enumerate}
